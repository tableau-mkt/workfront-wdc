...
describe('workfront-connector:setup', function describesConnectorSetup() {
  var setUpComplete;
...
describe('workfront-connector:columnHeaders', function describesConnectorColumnHeaders() {
  var registerHeaders;
...
describe('workfront-connector:tableData', function describesConnectorTableData() {
  var registerData;
...
describe('workfront-connector:teardown', function describesConnectorTearDown() {
